...
public class FilterInformation {
    ...
    @Builder
    private FilterInformation(Integer openIssueCount, Integer closedIssueCount, Integer labelCount, Integer milestoneCount, List<IssueInformation> issueInformations) {
